...
export class DemoResizeableObject extends DemoBase
{
    ...
    public static async fetchGeneratorImage (engine: Engine, index: number, scale: PIXI.Point = new PIXI.Point(1, 1)): Promise<PIXI.Sprite>
    {
    ...
    public async Initalize (): Promise<void>
    {
        ...
        this.Target = await DemoResizeableObject.fetchGeneratorImage(this.Engine, 0, new PIXI.Point(10, 10))
